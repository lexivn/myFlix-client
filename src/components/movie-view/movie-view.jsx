  ...
  return (
    <Container>
      <Row className="d-flex justify-content-around">
        <Card className="postcard small">
          <Card.Img className="mt-3" src={movie.ImagePath} width={100} alt="Movie Poster"/>
          <Card.Body >
      ...
      <Row className="mt-3 justify-content-md-center align-items-center">
        {similarMovies.map((movie) => {
          return (            
              <Col /*style={{ border: "1px solid red" }}*/ className="h-100 mb-4" key={movie._id} xs={12} sm={6} md={4} lg={3}>
                <Card className="mb-4" key={movie._id}>
                  <Card.Img src={movie.ImagePath} alt="Movie Poster"/>
                  <Card.Body>
                    <Card.Title>{movie.Title}</Card.Title>
                  </Card.Body>
                </Card>
